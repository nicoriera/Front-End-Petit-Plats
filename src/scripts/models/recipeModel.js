export class Recipes {
  ...
  getApplianceList() {
    ...
    const appliances = this.getRecipesFilteredBySearch().map(
  ...
  removeTag(arrayToFilter, type, value) {
    ...
    let deletedTagIndex = arrayToFilter.findIndex(
  ...
  getRecipesFilteredBySearch() {
    ...
    this.filteredRecipes = this.filteredRecipes.length
      ? this.filteredRecipes
      : this.recipeList;
    this.filteredRecipes = this.filteredRecipes.filter(
      (recipe) =>
        this.removeAccents(recipe.name.toLowerCase()).includes(
        ...
        this.removeAccents(recipe.description.toLowerCase()).includes(
          this.removeAccents(this.mainSearch.toLowerCase())
        )
    );
        ...
        if (tag.type === "ingredients") {
          return recipe.ingredients.some(
            (ingredient) =>
              ...
              this.removeAccents(tag.value.toLowerCase())
          );
        } else if (tag.type === "appliances") {
          return (
            this.removeAccents(recipe.appliance.toLowerCase()) ===
            this.removeAccents(tag.value.toLowerCase())
          );
